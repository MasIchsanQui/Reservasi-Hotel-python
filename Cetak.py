...
"}")
    ...
    "SELECT "
        ...
        "CASE "
            ...
            "ELSE 0 "
        "END AS harga, "
        "DATEDIFF(Transaksi.tanggal_out, Transaksi.tanggal_in) AS num_days "
    "FROM Transaksi "
    ...
    "JOIN Kamar ON Transaksi.no_kamarFK = Kamar.no_kamar;"
        ...
        while not self.baris.is_empty():
            ...
            id_transaksi, nama_tamu, tanggal_in, tanggal_out, no_kamar, jenis_kamar, harga, num_days = baris_data
    ...
    def create_payment_receipt(self, file_name, id_transaksi, nama_tamu, no_kamar, jenis_kamar, tanggal_in, tanggal_out, harga, total_cost, num_days):
        ...
        c.image(logo_path, x=15, y=20, w=30)
        ...
        # Add billing details
        c.set_font('Arial', '', 12)
        c.cell(0, 10, f"Harga Kamar      : Rp. {harga}", 0, 1, 'L')
        c.set_font('Arial', '', 12)
